...
function rootReducer(state = defaultState, action) {
  ...
  switch (action.type) {
    ...
    case SAVE_ROLE:
      const updatedRoleIndex = newState.roles.findIndex(
    ...
    case ADD_HABIT:
      roleIndex = newState.roles.findIndex(
        role => role.id == action.payload.roleId
      );
      newState.roles[roleIndex].habits = _.concat(
        newState.roles[roleIndex].habits,
        action.payload.newHabit
      );
    ...
    case DELETE_HABIT:
      ...
      newState.roles[roleIndex].habits = newState.roles[
        roleIndex
      ].habits.filter(habit => habit.id != action.payload.habitId);
    ...
    case SAVE_HABIT:
      ...
      habitIndex = newState.roles[roleIndex].habits.findIndex(
        habit => habit.id == action.payload.habitId
      );
      newState.roles[roleIndex].habits[habitIndex].title = action.payload.title;
      newState.roles[roleIndex].habits[habitIndex].description =
    ...
    case UPDATE_FREQ:
      ...
      newState.roles[roleIndex].habits[habitIndex].frequency =
    ...
    case ADD_SAMPLE:
      ...
      sampleIndex = newState.roles[roleIndex].habits[
        habitIndex
      ].samples.findIndex(
        sample => sample.date === action.payload.newSample.date
      );
      if (sampleIndex === -1) {
        newState.roles[roleIndex].habits[habitIndex].samples.push(
          action.payload.newSample
        );
        return newState;
      } else {
        newState.roles[roleIndex].habits[habitIndex].samples[sampleIndex] =
          action.payload.newSample;
        return newState;
      }
    ...
    case UPDATE_SAMPLE:
      ...
      sampleIndex = newState.roles[roleIndex].habits[
        ...
        sample => sample.date === action.payload.updatedSample.date
      );
    ...
    case UPDATE_SAMPLE_NOTES:
      ...
      sampleIndex = newState.roles[roleIndex].habits[
        habitIndex
      ].samples.findIndex(sample => sample.date === action.payload.date);
      if (sampleIndex === -1) {
        return newState;
      }
      newState.roles[roleIndex].habits[habitIndex].samples[sampleIndex].notes =
        action.payload.notes;
      newState.roles[roleIndex].habits[habitIndex].samples[
        sampleIndex
      ].changeFlag = action.payload.changeFlag;
      return newState;
    ...
    case ADD_GOAL:
      ...
      newState.roles[roleIndex].goals = _.concat(
        newState.roles[roleIndex].goals,
        action.payload.newGoal
      );
    ...
    case DELETE_GOAL:
      ...
      newState.roles[roleIndex].goals = newState.roles[roleIndex].goals.filter(
    ...
    case SAVE_GOAL:
      ...
      goalIndex = newState.roles[roleIndex].goals.findIndex(
        goal => goal.id == action.payload.goalId
      );
      newState.roles[roleIndex].goals[goalIndex].title = action.payload.title;
      newState.roles[roleIndex].goals[goalIndex].description =
        action.payload.description;
