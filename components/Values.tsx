function Values() {
  return (
    <div>
      ...
      <p>
        <b>
          Triune God-The Father, His only Son Jesus Christ, and Holy Spirit; as
      ...
      <p>
        <b>The Constitution</b> Which must be implemented and interpreted as it
      ...
      <p>
        <b> Justice</b> Evenly administered under the Constitution and the Bill
        of Rights, free of Judiciary Activism
      </p>
      <p>
        <b>Individual Rights</b> In particular: freedom of speech, religion, and
        the right to bear arms, property, and the pursuit of happiness
      </p>
      <p>
