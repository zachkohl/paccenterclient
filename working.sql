...
--explanation of trigger scheme https://medium.com/@simon.white/postgres-publish-subscribe-with-nodejs-996a7e45f88

-- CREATE OR REPLACE FUNCTION notify_new_visit
-- ()
--   RETURNS trigger AS
-- $BODY$
-- BEGIN
--         PERFORM pg_notify
-- ('new_visit', row_to_json
-- (NEW)::text);
-- RETURN NULL;
-- END; 
-- $BODY$
...
--   CREATE TRIGGER notify_new_visit
--   AFTER INSERT
--   ON "visits"
--   FOR EACH ROW
--   EXECUTE PROCEDURE notify_new_visit();